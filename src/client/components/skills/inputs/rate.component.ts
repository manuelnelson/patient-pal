...
@Component({
    ...
    template: require('./rate.component.html')
})
export class RateComponent implements OnInit{
    ...
    save(){
        let skillData = this.skillDataService.buildApiModel(this.skill._id, this.clientCurriculum._id,this.trialNumber,this.counter,null, '', this.timerValue);
